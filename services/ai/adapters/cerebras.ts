...
// Cerebras — wafer-scale compute for ultra-fast inference
export function createCerebrasAdapter(apiKey: string): AIProviderAdapter {
  const BASE = 'https://api.cerebras.ai/v1/chat/completions';

  const MODEL_MAP: Record<string, string> = {
    classify:  'llama-3.1-8b',
    summarize: 'llama-3.1-70b',
    extract:   'llama-3.1-8b',
    generate:  'llama-3.1-70b',
    score:     'llama-3.1-8b',
  };
