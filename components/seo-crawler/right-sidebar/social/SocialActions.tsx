  ...
  return (
    <div className="flex flex-col gap-3 p-3">
      ...
      {s.alerts.length > 0 && (
        <Card padded={false}>
          <div className="px-3 py-2 border-b border-[#1f1f1f]">
            <span className="text-[11px] text-[#888]">Priority alerts</span>
          </div>
      ...
      {s.actions.byReason.length > 0 && (
        <Card padded={false}>
          <div className="px-3 py-2 border-b border-[#1f1f1f]">
            <span className="text-[11px] text-[#888]">By reason</span>
          </div>
          <div className="flex flex-col border-t border-[#1f1f1f]">
            {s.actions.byReason.map(r => (
              <div key={r.id} className="flex items-center justify-between px-3 py-2 border-b border-[#1f1f1f] last:border-b-0">
