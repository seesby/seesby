    ...
    <div className="flex flex-col gap-3 p-3">
      ...
      <Card>
        <div className="flex items-center justify-between gap-3">
          <div>
            <div className="text-[11px] uppercase tracking-wide text-[#888]">NAP consistency</div>
            <div className="mt-1 text-2xl font-semibold text-white">{consistencyPct}%</div>
            <div className="mt-1 text-[10px] text-[#666]">Name, Address, Phone match across directories</div>
          </div>
