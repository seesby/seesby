      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <Card title="UGC Hashtags">
          {hashtags.length > 0 ? (
            ...
            <div className="text-[11px] text-[#555]">No UGC hashtags found</div>
          )}
        </Card>
      </div>
            ...
            <div key={i} className="py-2 border-b border-[#141414] last:border-0">
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] text-[#ccc] truncate max-w-[250px]">
              ...
              {review.text && (
                <div className="text-[10px] text-[#888] line-clamp-2 mt-1">{review.text}</div>
              )}
              <div className="flex items-center gap-3 text-[10px] text-[#555] mt-1">
