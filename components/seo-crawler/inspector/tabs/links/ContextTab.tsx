  ...
  return (
    <div className="space-y-4">
      ...
      <Card title="Surrounding text">
        <div className="mb-3 pb-3 border-b border-[#141414]">
          <div className="text-[11px] text-[#ccc] leading-relaxed">
            {surroundingText !== '—'
              ? <span>"…{surroundingText}…"</span>
              : <span className="italic text-[#555]">No surrounding text data available.</span>
            }
          </div>
        </div>
  ...
  return (
    <div className="mb-2">
      <div className="flex items-center justify-between mb-1">
        ...
        <span className="text-[11px] font-mono text-[#aaa]">{formatNumber(count)} ({pct.toFixed(1)}%)</span>
      </div>
