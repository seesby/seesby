  ...
  return (
    <div className="space-y-3">
          ...
          <table className="w-full text-[11px]">
            <thead>
              <tr className="border-b border-[#1a1a1a]">
                ...
                <th className="px-3 py-1.5 text-left text-[9px] text-[#444] uppercase tracking-widest font-bold">Name</th>
                <th className="px-3 py-1.5 text-left text-[9px] text-[#444] uppercase tracking-widest font-bold">Address</th>
                <th className="px-3 py-1.5 text-left text-[9px] text-[#444] uppercase tracking-widest font-bold">Phone</th>
                <th className="px-3 py-1.5 text-center text-[9px] text-[#444] uppercase tracking-widest font-bold">Name</th>
                <th className="px-3 py-1.5 text-center text-[9px] text-[#444] uppercase tracking-widest font-bold">Addr</th>
                <th className="px-3 py-1.5 text-center text-[9px] text-[#444] uppercase tracking-widest font-bold">Phone</th>
                <th className="px-3 py-1.5 text-right text-[9px] text-[#444] uppercase tracking-widest font-bold">Status</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, i) => (
                <tr key={i} className="border-b border-[#111] bg-[#0a0a0a] hover:bg-[#141414]">
                  <td className="px-3 py-1.5 text-[#ccc] font-medium">{row.source}</td>
                  <td className="px-3 py-1.5 text-[#aaa] truncate max-w-[120px]">{row.name || '\u2014'}</td>
                  <td className="px-3 py-1.5 text-[#aaa] truncate max-w-[150px]">{row.address || '\u2014'}</td>
                  <td className="px-3 py-1.5 text-[#aaa] font-mono">{row.phone || '\u2014'}</td>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
        <div className="bg-[#0e0e0e] border border-[#1a1a1a] rounded-lg p-3 text-center">
          <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Name match</div>
          <div className={`text-[20px] font-black ${nameMatches === rows.length ? 'text-green-400' : 'text-orange-400'}`}>
            {nameMatches}/{rows.length}
          </div>
        </div>
        <div className="bg-[#0e0e0e] border border-[#1a1a1a] rounded-lg p-3 text-center">
          <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Address match</div>
          <div className={`text-[20px] font-black ${addrMatches === rows.length ? 'text-green-400' : 'text-orange-400'}`}>
            {addrMatches}/{rows.length}
          </div>
        </div>
        <div className="bg-[#0e0e0e] border border-[#1a1a1a] rounded-lg p-3 text-center">
          <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Phone match</div>
          <div className={`text-[20px] font-black ${phoneMatches === rows.length ? 'text-green-400' : 'text-orange-400'}`}>
            {phoneMatches}/{rows.length}
          </div>
        </div>
        <div className="bg-[#0e0e0e] border border-[#1a1a1a] rounded-lg p-3 text-center">
          <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Exact all</div>
      ...
      <Card title="Schema NAP vs Official">
        <div className="bg-[#060606] border border-[#1a1a1a] rounded-lg overflow-hidden">
          <table className="w-full text-[11px]">
            <thead>
              <tr className="border-b border-[#1a1a1a]">
                <th className="px-3 py-1.5 text-left text-[9px] text-[#444] uppercase tracking-widest font-bold">Field</th>
                <th className="px-3 py-1.5 text-left text-[9px] text-[#444] uppercase tracking-widest font-bold">Official</th>
                <th className="px-3 py-1.5 text-left text-[9px] text-[#444] uppercase tracking-widest font-bold">Schema</th>
                <th className="px-3 py-1.5 text-center text-[9px] text-[#444] uppercase tracking-widest font-bold">Match</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-[#111] bg-[#0a0a0a]">
                <td className="px-3 py-1.5 text-[#888]">Name</td>
                <td className="px-3 py-1.5 text-[#ccc]">{officialName || '\u2014'}</td>
                <td className="px-3 py-1.5 text-[#ccc]">{schemaName || '\u2014'}</td>
              ...
              <tr className="border-b border-[#111] bg-[#0a0a0a]">
                <td className="px-3 py-1.5 text-[#888]">Address</td>
                <td className="px-3 py-1.5 text-[#ccc]">{officialAddress || '\u2014'}</td>
                <td className="px-3 py-1.5 text-[#ccc]">{schemaAddress || '\u2014'}</td>
              ...
              <tr className="bg-[#0a0a0a]">
                <td className="px-3 py-1.5 text-[#888]">Phone</td>
                <td className="px-3 py-1.5 text-[#ccc]">{officialPhone || '\u2014'}</td>
                <td className="px-3 py-1.5 text-[#ccc]">{schemaPhone || '\u2014'}</td>
