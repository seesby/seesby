    ...
    <div className="space-y-4">
      ...
      <Card title="Targeting">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Geo</div>
          ...
          <div>
            <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Device</div>
        ...
        <div className="mt-3 grid grid-cols-2 gap-4">
          <div>
            <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Audience</div>
            <DataRow label="Remarketing" value={page?.remarketingList || '—'} />
            <DataRow label="Similar" value={page?.similarAudience || '—'} />
          </div>
          <div>
            <div className="text-[9px] text-[#444] uppercase tracking-wider mb-1">Ad schedule</div>
