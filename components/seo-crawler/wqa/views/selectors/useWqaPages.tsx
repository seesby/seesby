  ...
  const columns = useMemo<ColumnDef<any>[]>(() => {
    const result: ColumnDef<any>[] = [
      ...
      },
      {
        ...
        cell: c => {
          const v = c.getValue() as number;
          if (!v) return <span className="text-[11px] text-[#666]">--</span>;
      ...
      },
      {
        ...
        cell: c => {
          ...
          if (!v) return <span className="text-[11px] text-[#666]">-- no kw</span>;
          return <span className="text-[11px] text-[#ccc] truncate block">{v}</span>;
        },
      },
      {
