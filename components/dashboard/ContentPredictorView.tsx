                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="col-span-3 grid grid-cols-3 gap-4">
                                <div className="bg-[#111] p-5 rounded-2xl border border-white/5">
                                    ...
                                    <span className="block text-xs font-bold text-gray-500 uppercase">Search Intent</span>
                                    <span className="block text-lg font-bold text-white mt-1">{result.intent}</span>
                                </div>
                                <div className="bg-[#111] p-5 rounded-2xl border border-white/5">
                                    <BarChart2 size={18} className="text-gray-400 mb-3" />
                                    <span className="block text-xs font-bold text-gray-500 uppercase">Search Volume</span>
                                ...
                                <div className="bg-[#111] p-5 rounded-2xl border border-white/5">
                                    ...
                                    <span className="block text-xs font-bold text-gray-500 uppercase">Difficulty</span>
                            ...
                            <div className="bg-[#0F0F0F] rounded-2xl border border-white/5 p-6 space-y-4">
                                ...
                                <div className="space-y-4">
                                    {result.outline?.map((section: any, idx: number) => (
                                        <div key={idx} className="bg-[#151515] p-4 rounded-xl border border-white/5">
                                            ...
                                            <ul className="space-y-1">
                                                {section.subtopics?.map((sub: string, i: number) => (
                                                    <li key={i} className="text-xs text-gray-400 flex items-center gap-2">
                                                        <ChevronRight size={12} className="text-gray-600" /> {sub}
                                                    </li>
                                                ))}
                                            </ul>
                                        </div>
