                        ...
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-white/5">
                                {competitors.map((comp) => (
                                    <tr key={comp.id} className="group hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <button onClick={() => removeCompetitor(comp.id)} className="text-gray-500 hover:text-red-500 transition-colors">
                                                <Trash2 size={16} />
                                            </button>
                                        </td>
                                    </tr>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                    <div className="bg-[#0F0F0F] rounded-3xl border border-white/5 p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-6">Compare your performance across key areas.</p>
                ...
                <div className="fixed inset-0 z-[100] bg-black/80 flex items-center justify-center backdrop-blur-sm p-4">
                    <div className="bg-[#111] border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
                        ...
                        <div className="p-6 space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-gray-400 mb-1">Competitor Name</label>
                                <input
                                    type="text"
                                    value={newName}
